...
<div className='flex justify-between items-center border-b-2 p-3'>
  <div className='flex gap-7 mb-4 h-full'>
    ...
    <div className='flex justify-center items-center gap-2 h-full'>
        <img src={heart} className='w-[12px]'/>
...
<div>
    <div className='flex justify-center items-center gap-2 border-[1px] w-[204px] h-[37px] p-1 rounded-full'>
        <img src={filter} className='w-[15px]'/>
        <div className='font-[600] text-[12px]'>Personalize Your Feed</div>
    </div>
</div>
